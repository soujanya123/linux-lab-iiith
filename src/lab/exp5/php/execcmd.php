...
else if($maincmd=="ls"||$cmd=="pwd"||$maincmd=="ps"||$maincmd=="mkdir"||$maincmd=="kill"||$maincmd=="nohup"||$maincmd=="renice"||$maincmd=="rm"||$maincmd=="rmdir"||$maincmd=="du"||$maincmd=="df"||$maincmd=="cat"||$maincmd=="echo"||$maincmd=="svn"||$maincmd=="whoami"||$maincmd=="su"||$maincmd=="id"||$maincmd=="useradd"||$maincmd=="tail"||$maincmd=="usermod"||$maincmd="groupadd"){
